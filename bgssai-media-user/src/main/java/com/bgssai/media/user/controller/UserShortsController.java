...
/**
 * Authenticated user catalog/play path for shorts ingested from bgssai-short.
 */
@RestController
@RequestMapping("/api/shorts")
@NeedAop(roles = {RoleCodes.USER})
public class UserShortsController {

    private final ShortDramaContractService shortDramaContractService;

    public UserShortsController(ShortDramaContractService shortDramaContractService) {
