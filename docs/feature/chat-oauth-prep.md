...
bgssai.media.chat.oauth.authorize-url=https://www.bgssai-chat.cn/oauth/authorize
bgssai.media.chat.oauth.token-url=https://www.bgssai-chat.cn/oauth/token
bgssai.media.chat.oauth.userinfo-url=https://www.bgssai-chat.cn/oauth/userinfo
