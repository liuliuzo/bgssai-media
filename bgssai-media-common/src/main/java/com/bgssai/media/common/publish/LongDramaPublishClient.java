...
/** HTTP poster long (or smoke) uses to publish a packaged long episode to media. */
public final class LongDramaPublishClient {

    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;
    private final String mediaBaseUrl;

    public LongDramaPublishClient(String mediaBaseUrl) {
    ...
    public LongDramaPublishClient(String mediaBaseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public String ingestUrl() {
        return mediaBaseUrl + LongDramaPublishJob.INGEST_PATH;
    }

    public HttpRequest buildRequest(String ingestToken, LongDramaIngestRequest payload) {
        ...
        try {
            ...
            return HttpRequest.newBuilder()
                    ...
                    .header(LongDramaPublishJob.TOKEN_HEADER, ingestToken)
    ...
    public Map<String, Object> publish(String ingestToken, LongDramaIngestRequest payload) {
        try {
