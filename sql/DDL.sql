...
-- -----------------------------------------------------------------------------
-- 站内在线客服（留言 / 会话）— 对齐 BGSSAI 全产品在线客服标准 2026-09-19
-- support=in-app messaging；本阶段不做第三方 SaaS / 强制 Bot 智能客服
-- -----------------------------------------------------------------------------
...
-- 聊中提工单：工单挂接会话，不替代聊天（chat-first + ticket-from-chat）
...
-- -----------------------------------------------------------------------------
-- AUD20-020 / AUD20-021 创作者上传转码 + 频道社区（非剧集分集）
-- -----------------------------------------------------------------------------
